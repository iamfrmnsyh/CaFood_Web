...
<head>
    ...
    <style>
        * {
        ...
        /* Tombol Keranjang di KANAN - sudah benar posisinya */
        .cart-icon-header {
            position: absolute;
            top: 20px;
            right: 20px;
...
<body>
    ...
    <script>
       ...
       const standsData = [
        ...
        const currentStand = standsData.find(s => s.id === standId);
            ...
            if (summaryContainer) {
                if (cart.length === 0) {
                    summaryContainer.innerHTML = `
                        ...
                        <button class="view-cart-btn" onclick="window.location.href='keranjang.html'">View Cart</button>
                    `;
                } else {
                    summaryContainer.innerHTML = `
                        <div class="cart-total">
    ...
    showToast(`${menu.name} ditambahkan!`);
       ...
       function updateQuantity(menuId, change) {
            ...
            saveCart();
            renderMenus(); // 🔥 penting: refresh UI biar angka berubah
        }
